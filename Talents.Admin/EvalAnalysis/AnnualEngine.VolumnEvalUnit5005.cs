...
namespace TheSite.EvalAnalysis
{
	...
	public partial class AnnualEngine
	{
		...
		public class VolumnEvalUnit5005 : VolumnEvalUnit
		{
				...
				List<DeclareActive> source, ref string analysis)
			{
				...
				items.Add(item);
				var tempStr = "\"自身发展.担任评委工作\"分析: 您还需要参加区级以上的\"担任评委工作\", 可以获得此项满分。";
				...
				List<DeclareAchievement> source, ref string analysis)
			{
				...
				var tempStr = "\"自身发展.项目研究\"分析： 您还需要参加校级以上的\"项目研究\"， 可以获得此项满分。";
				...
				List<DeclareActive> source, ref string analysis)
			{
				...
				var tempStr = "\"培训课程.讲座、报告\"分析： 您需要参加校级以上的\"讲座、报告\"， 可以获得此项满分。";
				...
				List<DeclareActive> source, ref string analysis)
			{
				...
				var tempStr = "\"培训课程.课程资源开发\"分析： 您还需要参加校级以上的\"课程资源开发\"， 可以获得此项满分。";
			...
			private void XueyShul(int MemberCount, EvalVolumnResult result, List<EvalVolumnResultItem> items)
			{
				...
				else if (MemberCount > 0 & MemberCount < 2)
				{
					result.Score += 2.5;
					item.ChooseValue = "B";
					item.ResultValue = "2.5分";
				...
				if (MemberCount < 3)
				{
					result.AnalysisContent += string.Format("\"带教教师.学员数量\"分析： 你还需带{0}学员， 可以获得此项满分。", 3 - MemberCount);
				}
			}
