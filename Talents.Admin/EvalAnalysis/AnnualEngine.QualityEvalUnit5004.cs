	...
	public partial class AnnualEngine
	{
		...
		public class QualityEvalUnit5004 : QualityEvalUnit
		{
			...
			private void Analysis_KetJiaox_Gongkk(EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items, string choose, string score)
			{
				...
				{
					case "A":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 13.5, 15.0);
						break;
					case "B":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 9.0, 13.4);
						break;
					case "C":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 0, 8.9);
						break;	
				}
