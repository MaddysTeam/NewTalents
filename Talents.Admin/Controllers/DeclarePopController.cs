...
namespace TheSite.Controllers
{
   ...
   public class DeclarePopController : BaseController
   {
      ...
      {
         var model = new ZisFaz_JiaoxHuod_JiaoxGongkkModel() { Date = System.DateTime.Now, AttachmentName = "" };
      ...
      public ActionResult ZisFaz_JiaoxHuod_JiaoxPingb(long? id)
      {
         var model = new ZisFaz_JiaoxHuod_JiaoxPingbModel() { Date = System.DateTime.Now, AttachmentName = "" };
      ...
      public ActionResult ZisFaz_KeyChengg_KetYanj(long? id)
      {
         ...
         if (id != null)
         {
            ...
            if (list != null)
            {
               ...
               if (allAts.Count > 0)
               {
                  var ats = allAts.FindAll(a => a.Type == AttachmentsKeys.ZisFaz_KeyChengg_KetYanj);
      ...
      public ActionResult ZisFaz_KeyChengg_KetYanj(long? id, ZisFaz_KeyChengg_KetYanjModel model)
      {
         ...
         var attachmentTypeKey = AttachmentsKeys.ZisFaz_KeyChengg_KetYanj;
         var vertifyTypeKey = AttachmentsKeys.ZisFaz_KeyChengg_KetYanj + AttachmentsKeys.Vertify;
         var atta = new AttachmentsDataModel
         {
            Type = attachmentTypeKey,
            Name = model.AttachmentName,
         ...
         try
         {
            if (id == null)
            {
               var data = new DeclareAchievement()
               {
                  TeacherId = UserProfile.UserId,
            ...
            AddOrDelShare(atta.JoinId, model.NameOrTitle, ShareKeys.AchievementShare, model.IsShare);
      ...
      public ActionResult ZhidJians_DangaJians(long? id, DeclareOrgConst model)
      {
         ...
         if (id == null)
         {
            db.DeclareOrgConstDal.Insert(new DeclareOrgConst()
            {
               TeacherId = UserProfile.UserId,
