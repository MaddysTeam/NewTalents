...
namespace TheSite.Controllers
{
   ...
   public class JsonController : BaseController
   {
      ...
      public ActionResult GetDecalreMaterial(long? userId)
      {
         ...
         var xuekDaitReng = new json_treenode { id = DeclareTargetIds.XuekDaitr.ToString(), text = "学科带头人", type = json_treenode_types.database, children = new List<json_treenode>() };
         ...
         var gugJiaos = new json_treenode { id = DeclareTargetIds.GugJiaos.ToString(), text = "骨干教师", type = json_treenode_types.database, children = new List<json_treenode>() };
         ...
         gugJiaos.children.Add(new json_treenode { id = DeclareKeys.GugJiaos_CaiLPog, text = "材料破格" });
