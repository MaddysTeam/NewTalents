   ...
   public partial class DeclareEngine
   {
      ...
      public class DeclareEvalUnit5004 : DeclareEvalUnit
      {
         ...
         protected override void AnalysisResult(FormCollection fc, EvalDeclareResult result, Dictionary<string, EvalDeclareResultItem> items)
         {
            ...
            if (fc[EvalDeclareRuleKeys.JiaosPeix_Jiangz] != null)
               score += Analysis_JiaosPeix_Jiangz(result, items, fc[EvalDeclareRuleKeys.JiaosPeix_Jiangz], fc[EvalDeclareRuleKeys.JiaosPeix_Jiangz_Def]);
         ...
         private double Analysis_JiaosPeix_Jiangz(EvalDeclareResult result, Dictionary<string, EvalDeclareResultItem> items, string choose, string score)
         {
            var item = new EvalDeclareResultItem
            {
               ChooseValue = choose,
               EvalItemKey = EvalDeclareRuleKeys.JiaosPeix_Jiangz,
            };
            items.Add(item.EvalItemKey, item);
