...
namespace TheSite.EvalAnalysis
{
   ...
   public partial class DeclareEngine
   {
      ...
      public class DeclareEvalUnit5004 : DeclareEvalUnit
      {
         ...
         {
            var score = Analysis_JiaoyJiaox_Gongkk(result, items, fc[EvalDeclareRuleKeys.JiaoyJiaox_Gongkk], fc[EvalDeclareRuleKeys.JiaoyJiaox_Gongkk_Def]);

            var score1 = Analysis_JiaoyJiaox_Pb_Quj(result, items, fc[EvalDeclareRuleKeys.JiaoyJiaox_Pb_Quj], fc[EvalDeclareRuleKeys.JiaoyJiaox_Pb_Quj_Def]);
            var score2 = Analysis_JiaoyJiaox_Pb_Qit(result, items, fc[EvalDeclareRuleKeys.JiaoyJiaox_Pb_Qt], fc[EvalDeclareRuleKeys.JiaoyJiaox_Pb_Qt_Def]);
