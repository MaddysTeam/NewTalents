	...
	public partial class AnnualEngine
	{
		...
		public class QualityEvalUnit5005 : QualityEvalUnit
		{
			...
			protected override void AnalysisResult(FormCollection fc, EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items)
			{
				...
				result.Score += EvalHelper.GetScore(20, score1, score2, score3);
				...
				result.Score += EvalHelper.GetScore(25, score4, score5, score6);
				...
				result.Score += EvalHelper.GetScore(8, score10, score11, score12);
			...
			private void Analysis_ZisFaz_DusHuod(EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items, string choose, string score)
			{
				...
				{
					case "1A":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 4.5, 5);
						break;
					case "1B":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 4.0, 4.5);
						break;
					case "1C":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 3.5, 4.0);
						break;
					case "1D":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 3.0, 3.5);
						break;
					case "2A":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 3.0, 3.5);
						break;
					case "2B":
						result.Score += EvalHelper.EnsureScoreInRange(scoreValue, 1.5, 2.0);
						break;
					case "2C":
						scoreValue = 0;
						break;
			...
			private double Analysis_ZisFaz_KaizShik(EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items, string choose, string score)
			{
				...
				{
					case "1A":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 18.0, 20.0);
						break;
					case "1B":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 16.0, 18.0);
						break;
					case "1C":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 14.0, 16.0);
						break;
					case "1D":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 12.0, 14.0);
						break;
					case "2A":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 8.0, 10.0);
						break;
					case "2B":
						scoreValue = 0;
						break;
			...
			private double Analysis_ZisFaz_FabLunw(EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items, string choose, string score)
			{
				...
				{
					case "1A":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 22.0, 25.0);
						break;
					case "1B":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 20.0, 22.0);
						break;
					case "1C":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 17.0, 20.0);
						break;
					case "1D":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 15.0, 17.0);
						break;
					case "2A":
						scoreValue = 0;
						break;
			...
			private void Analysis_DaijJiaos_DaijZhid(EvalQualityResult result, Dictionary<string, EvalQualityResultItem> items, string choose, string score)
			{
				...
				{
					case "1A":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 6.3, 7);
						break;
					case "1B":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 5.6, 6.3);
						break;
					case "1C":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 4.9, 5.6);
						break;
					case "1D":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 4.2, 4.9);
						break;
					case "2A":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 2.8, 3.5);
						break;
					case "2B":
						scoreValue = EvalHelper.EnsureScoreInRange(scoreValue, 1.4, 2.1);
						break;
					case "2C":
						scoreValue += 0;
						break;
